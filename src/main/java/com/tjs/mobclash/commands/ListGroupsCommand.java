...
public class ListGroupsCommand extends BaseCommand {
    ...
    public ListGroupsCommand(JavaPlugin plugin, SpawnManager spawnManager, LanguageManager langManager) {
    ...
    protected boolean execute(CommandSender sender, String[] args) {
        ...
        for (Map.Entry<String, List<Location>> entry : groups.entrySet()) {
            sender.sendMessage(langManager.getMessage("listgroups-entry", 
