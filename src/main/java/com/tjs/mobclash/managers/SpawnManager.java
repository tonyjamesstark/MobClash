...
public class SpawnManager {
    ...
    private void loadConfigData() {
        ...
        if (config.contains("spawn-groups")) {
            ...
            if (groupsSection != null) {
                for (String groupName : groupsSection.getKeys(false)) {
                    ...
                    plugin.log(Level.INFO, "Loaded group '" + groupName + "' with " + locations.size() + " spawn points");
                }
            }
        }
            ...
            if (chestsSection != null) {
                for (String groupName : chestsSection.getKeys(false)) {
                    ...
                    if (chestSection != null) {
                        ...
                        plugin.log(Level.INFO, "Loaded chest for group '" + groupName + "' at " + 
        ...
        plugin.log(Level.INFO, "Configuration loaded: " + spawnGroups.size() + " groups, " + 
            groupChests.size() + " chests");
    }
    ...
    public void saveConfigData() {
        ...
        for (Map.Entry<String, List<Location>> entry : spawnGroups.entrySet()) {
            ...
            plugin.log(Level.INFO, "Saved " + locations.size() + " spawn points for group '" + groupName + "'");
        }
    ...
    public void addSpawnPoint(String groupName, Location location) {
        ...
        plugin.log(Level.INFO, "Added spawn point to group '" + groupName + "' at " +
    ...
    public boolean removeNearestSpawnPoint(String groupName, Location playerLocation) {
        if (!spawnGroups.containsKey(groupName)) {
            plugin.log(Level.INFO, "Attempted to remove spawn from non-existent group '" + groupName + "'");
            return false;
        }
        ...
        plugin.log(Level.INFO, "Removed spawn point from group '" + groupName + "' at " +
            String.format("(%.1f, %.1f, %.1f), %.1f blocks away", 
    ...
    public void setGroupChest(String groupName, Location chestLocation) {
        ...
        plugin.log(Level.INFO, "Set chest for group '" + groupName + "' at " +
            String.format("(%.1f, %.1f, %.1f) in %s", 
