...
class AddSpawnCommandTest {
    ...
    void testPlayerWithPermissionCanAddSpawn() {
        ...
        boolean result = addSpawnCommand.onCommand(player, command, "addspawn", new String[]{"test-group"});
    ...
    void testCommandBlockBypassesPermission() {
        ...
        boolean result = addSpawnCommand.onCommand(commandBlock, command, "addspawn", new String[]{"test-group"});
    ...
    void testConsoleCannotExecute() {
        ...
        boolean result = addSpawnCommand.onCommand(console, command, "addspawn", new String[]{"test-group"});
